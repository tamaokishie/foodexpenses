...
export function MealDashboard({ title, setMealPrice }: props) {
        ...
        <Grid item xs={10}>
          <TableContainer component={Paper}>
            <Table>
              ...
              <TableHead>
                <TableRow>
                  <StyledTableCell sx={{ typography: 'body1' }}>
                    {title}
                  </StyledTableCell>
                  <StyledTableCell align='right' sx={{ typography: 'body1' }}>
                    {`合計 : ${totalPrice} 円`}
                  </StyledTableCell>
                </TableRow>
              </TableHead>
